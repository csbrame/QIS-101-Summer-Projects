...
def model(time, state_vector, phase_constant):
    # state vector encodes omega and theta
    omega, theta = state_vector
    # recall the phase constant is g/l
...
def main():
    ...
    # To create an ellipse, we want both pendula to be the same length
    # and travelling along the same theta to start
    # allowing both omega to be zero creates a line, so we increase
    # one to create an ellipse
    pendulum1_length = 1.5  # meters
    ...
    omega2_initial = 0.2  # radians/sec
